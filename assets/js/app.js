...
(() => {
  ...
  document.body.classList.remove("modal-open"); els.modalCancel.removeEventListener("click", cancel);}; els.modalOk.addEventListener("click", ok); els.modalCancel.addEventListener("click", cancel); }
